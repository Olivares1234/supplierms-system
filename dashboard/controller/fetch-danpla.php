...
try {
    $sql = 'SELECT * FROM tbl_supplier WHERE (sppr_raw_extension="Danpla") AND (sppr_status="Approved")';
        ...
        <tr>
            ...
            <td style="text-align: center;">
                ...
                <span class="border border-bottom" style="background: #f7f9fb;">
                    ...
                    <span class="border border-bottom" style="background: #f7f9fb;"><button type="button" class="btn-link btn-primary btn-md edit" data-id="<?php echo $row['id']; ?>" data-toggle="tooltip"  data-placement="top" title="Edit"  data-original-title="Edit">
