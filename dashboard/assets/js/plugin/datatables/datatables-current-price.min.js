...
$(document).ready(function(){
    ...
    $('#addForm').submit(function(e){
        ...
        $.ajax({
            method: 'POST',
            url: 'global/current-price-add.php',
            data: addform,
            dataType: 'json',
            success: function(response){
                ...
                if(response.error){
                    ...
                    // $('.loader').show();
                    // $(".loader").fadeOut(1000);
                    toastr.success("&nbsp;Successfully Send For Approval!");
                    $('#alert_message').html(response.message);
                    fetch();
                }
            }
    ...
    $('#viewForm').submit(function(e){
        e.preventDefault();
        var viewForm = $(this).serialize();
        $.ajax({
            method: 'POST',
            url: 'global/current-view.php',
            data: viewForm,
            dataType: 'json',
            success: function(response){
                if(response.error){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.error){
                    ...
                    // $('.loader').show();
                    // $(".loader").fadeOut(1000);
                    toastr.info("Error Failed to Update!");
                    $('#alert_message').html(response.message);
                }
                else{
                    // $('#alert').show();
                    ...
                    // $('.loader').show();
                    // $(".loader").fadeOut(1000);
                    toastr.success("&nbsp;Successfully Update<br>&nbsp;Details Supplier!");
                    $('#alert_message').html(response.message);
                    fetch();
                }
                $('#edit').modal('hide');
            ...
            success: function(response){
                ...
                if(response.error){
                  ...
                  // $('#alert').show();
                    ...
                    // $('.loader').show();
                    // $(".loader").fadeOut(1000);
                    toastr.success("Successfully Deleted Record Supplier!");
                    $('#alert_message').html(response.message);
                    fetch();
                }
...
function fetch(){
    $.ajax({
        method: 'POST',
        url: 'controller/fetch-current-price.php',
        success: function(response){
            // $('#tbody').html(response);
...
function getDetails(id){
    $.ajax({
        method: 'POST',
        url: 'controller/fetch_row_history_price.php',
        data: {sppr_p_id:id},
        dataType: 'json',
        success: function(response){
            if(response.error){
                ...
                let time = new Date(response.data.sppr_p_date_created);
                let datecurrent = time.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true });

                let todayDate = new Date(response.data.sppr_p_date_created).toISOString().slice(0, 10);
               

                        //text for viewing 
                         $('.sppr_p_id').val(response.data.sppr_p_id);
                         $('.sppr_p_raw_materials').text(response.data.sppr_p_raw_materials);
                         $('.sppr_p_company_name').text(response.data.sppr_p_company_name);
                         $('.sppr_p_product_list').text(response.data.sppr_p_product_list);
                         $('.sppr_p_address').text(response.data.sppr_p_address);
                         $('.sppr_p_current_price').text('₱ '+response.data.sppr_p_current_price);
                         $('.sppr_p_contact_person').text(response.data.sppr_p_contact_person);
                         $('.sppr_p_nationality').text(response.data.sppr_p_nationality);
                         $('.sppr_p_owner').text(response.data.sppr_p_owner);
                         $('.sppr_p_contact_num').text(response.data.sppr_p_contact_num);
                         $('.sppr_p_fax_num').text(response.data.sppr_p_fax_num);
                         $('.sppr_p_email').text(response.data.sppr_p_email);
                         $('.sppr_p_current_pay_terms').text(response.data.sppr_p_current_pay_terms);
                         $('.sppr_p_date_created').text(todayDate+" / "+datecurrent);
                         $('.sppr_p_year_approved').text(response.data.sppr_p_year_approved);
                         $('.sppr_p_status').text(response.data.sppr_p_status);
             
                         // val for editing value input
                         $('.sppr_p_raw_materials').val(response.data.sppr_p_raw_materials);
                         $('.sppr_p_company_name').val(response.data.sppr_p_company_name);
                         $('.sppr_p_product_list').val(response.data.sppr_p_product_list);
                         $('.sppr_p_address').val(response.data.sppr_p_address);
                         $('.sppr_p_current_price').val(response.data.sppr_p_current_price);
                         $('.sppr_p_contact_person').val(response.data.sppr_p_contact_person);
                         $('.sppr_p_nationality').val(response.data.sppr_p_nationality);
                         $('.sppr_p_owner').val(response.data.sppr_p_owner);
                         $('.sppr_p_contact_num').val(response.data.sppr_p_contact_num);
                         $('.sppr_p_fax_num').val(response.data.sppr_p_fax_num);
                         $('.sppr_p_email').val(response.data.sppr_p_email);
                         $('.sppr_p_current_pay_terms').val(response.data.sppr_p_current_pay_terms);
                         $('.sppr_p_date_created').val(response.data.sppr_p_date_created);
                         $('.sppr_p_year_approved').val(response.data.sppr_p_year_approved);
                         $('.sppr_p_status').val(response.data.sppr_p_status);
                        
                        // $('.sppr_current_pay_terms').text(response.data.sppr_current_pay_terms);
                        // $('.sppr_current_pay_terms').text(response.data.sppr_current_pay_terms);
                        // $('.sppr_current_pay_terms').text(response.data.sppr_current_pay_terms);
                        // $('.supplier_product_list').val(response.data.supplier_product_list);
