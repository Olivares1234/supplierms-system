...
$(document).ready(function(){
    ...
    $('#addForm').submit(function(e){
        ...
        $.ajax({
            method: 'POST',
            url: 'global/form-receipt-add.php',
            data: addform,
            dataType: 'json',
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.error){
                    ...
                    // $('.loader').show();
                    // $(".loader").fadeOut(1000);
                    toastr.info("No Changes Found Data Update Details Supplier!");
                    $('#alert_message').html(response.message);
                }
                else{
                    // $('#alert').show();
...
function fetch(){
    $.ajax({
        method: 'POST',
        url: 'controller/fetch-form-receipt.php',
        success: function(response){
            // $('#tbody').html(response);
        ...
        success: function(response){
            if(response.error){
                ...
                $('#alert_message').html(response.message);
                         ...
                         $('.sppr_raw_materials').text(response.data.sppr_raw_materials);
                         $('.sppr_company_name').text(response.data.sppr_company_name);
                         $('.sppr_address').text(response.data.sppr_address);
                         $('.sppr_product_lists').text(response.data.sppr_product_lists);
                         $('.sppr_current_price').text('₱ '+response.data.sppr_current_price);
                         $('.sppr_nationality').text(response.data.sppr_nationality);
                         $('.sppr_owner').text(response.data.sppr_owner);
                         $('.sppr_contact_num').text(response.data.sppr_contact_num);
                         $('.sppr_remarks').text(response.data.sppr_remarks);
                         $('.sppr_approved').text(response.data.sppr_approved);
                         $('.sppr_current_pay_terms').text(response.data.sppr_current_pay_terms);
                         $('.sppr_contact_person').text(response.data.sppr_contact_person);
                         $('.sppr_fax_num').text(response.data.sppr_fax_num);
                         $('.sppr_email').text(response.data.sppr_email);
                         $('.sppr_status').text(response.data.sppr_status);
                         $('.sppr_email_user').text(response.data.sppr_email_user);
         
                         // val for editing value input
                         $('.sppr_company_name').val(response.data.sppr_company_name);
                         $('.sppr_raw_materials').val(response.data.sppr_raw_materials);
                         $('.sppr_address').val(response.data.sppr_address);
                         $('.sppr_product_lists').val(response.data.sppr_product_lists);
                         $('.sppr_current_price').val(response.data.sppr_current_price);
                         $('.sppr_nationality').val(response.data.sppr_nationality);
                         $('.sppr_owner').val(response.data.sppr_owner);
                         $('.sppr_contact_num').val(response.data.sppr_contact_num);
                         $('.sppr_remarks').val(response.data.sppr_remarks);
                         $('.sppr_approved').val(response.data.sppr_approved);
                         $('.sppr_current_pay_terms').val(response.data.sppr_current_pay_terms);
                         $('.sppr_contact_person').val(response.data.sppr_contact_person);
                         $('.sppr_fax_num').val(response.data.sppr_fax_num);
                         $('.sppr_email').val(response.data.sppr_email);
                         $('.sppr_status').val(response.data.sppr_status);
                         $('.sppr_email_user').val(response.data.sppr_email_user);
