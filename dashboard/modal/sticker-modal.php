                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="hidden" style="text-transform: capitalize;" class="form-control" name="sppr_raw_materials" value="Sticker & Label">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="hidden" style="text-transform: capitalize;" class="form-control" name="sppr_raw_extension" placeholder="Enter Raw Extension..." value="Sticker" hidden>
                            </div>
                        </div>
            ...
            <div class="modal-body modal-lg">
                <form id="viewForm">
                    ...
                    <div class="row form-group">
                        <table class="table display table-bordered table-responsive" style="width: 100%">
                            <tr>
                                <th>Raw Item:</th>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" style="text-transform: capitalize;" class="form-control" name="sppr_raw_extension" placeholder="Enter Raw Extension..." value="Sticker" hidden>
                            </div>
                        </div>
