                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="hidden" style="text-transform: capitalize;" class="form-control" name="sppr_raw_materials" value="HDPE/PE & ESD Bag">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" style="text-transform: capitalize;" class="form-control" name="sppr_raw_extension" placeholder="Enter Raw Extension..." value="Hdpe" hidden>
                            </div>
                        </div>
