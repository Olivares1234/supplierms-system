...
<div class="modal fade" id="view" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body modal-lg">
                <form id="viewForm">
                    <input type="hidden" class="sppr_p_id" name="sppr_p_id">
                    <div class="row form-group">
                        <table class="table table-bordered table-responsive" style="width: 100%">
                            <tr>
                                <th>Raw Item:</th>
                                <td colspan="1" style="word-wrap: break-word;" class="sppr_p_raw_materials" name="sppr_p_raw_materials" value="sppr_raw_materials"></td>

                                <th>Supplier Name:</th>
                                <td colspan="3" ; style="word-wrap: break-word;" class="sppr_p_company_name" name="sppr_p_company_name" value="sppr_p_company_name"></td>

                            </tr>

                            <tr>
                                <th>Product List:</th>
                                <td colspan="0" ; style="word-wrap: break-word;" class="sppr_p_product_list" name="sppr_p_product_list" value="sppr_product_lists"></td>

                                <th>Address:</th>
                                <td colspan="3" ; style="word-wrap: break-word;" class="sppr_p_address" name="sppr_p_address" value="sppr_p_address"></td>

                            </tr>

                            <tr>
                                <th>Current Price:</th>
                                <td style="word-wrap: break-word;" class="sppr_p_current_price" name="sppr_p_current_price" value="sppr_p_current_price"></td>

                                <th>Date / Time:</th>
                                <td style="word-wrap: break-word;" class="sppr_p_date_created" name="sppr_p_date_created" value="sppr_p_date_created"></td>

                            </tr>

                            <tr>
                                <th>Owner:</th>
                                <td style="word-wrap: break-word;" class="sppr_p_owner" name="sppr_p_owner" value="sppr_p_owner"></td>

                                <th>Contact Person:</th>
                                <td colspan="3" style="word-wrap: break-word;" class="sppr_p_contact_person" name="sppr_p_contact_person" value="sppr_p_contact_person"></td>

                            </tr>

                            <tr>
                                <th>Contact #:</th>
                                <td colspan="0" ; style="word-wrap: break-word;" class="sppr_p_contact_num" name="sppr_p_contact_num" value="sppr_p_contact_num">

                                <th>Fax #:</th>
                                <td colspan="3" style="word-wrap: break-word;" class="sppr_p_fax_num" name="sppr_p_fax_num" value="sppr_p_fax_num"></td>

                            </tr>

                            <tr>
                                <th>Email Address / Website:</th>
                                <td style="word-wrap: break-word;" class="sppr_p_email" name="sppr_p_email" value="sppr_p_email"></td>

                                <th>Current Payment Terms:</th>
                                <td colspan="3" ; style="word-wrap: break-word;" class="sppr_p_current_pay_terms" name="sppr_p_current_pay_terms" value="sppr_p_current_pay_terms"></td>
                            ...
                            <tr>
                                <th>Year Approved:</th>
                                <td style="word-wrap: break-word;" class="sppr_p_year_approved" name="sppr_p_year_approved" value="sppr_p_year_approved"></td>

                                <!-- <th>Remarks:</th>
                                <td style="word-wrap: break-word; color:#209d8f;" class="sppr_remarks" name="sppr_remarks" value="sppr_remarks"></td> -->

                                <th>Status:</th>
                                <td style="word-wrap: break-word; font-weight:bold; color:#28a745;" class="sppr_p_status" name="sppr_p_status" value="sppr_p_status"></td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="modal-body modal-lg">
                ...
                <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                <label><b>Company Name:</b></label>
                                <input type="text" class="sppr_p_id" name="sppr_p_id" hidden>
                                <input type="hidden" style="text-transform: capitalize;" class="form-control" name="sppr_p_raw_materials" value="Danpla">
                                <input type="text" style="text-transform: capitalize;" class="form-control sppr_p_company_name" name="sppr_p_company_name" placeholder="Enter Company Name..." required>
                            </div>
                        </div>
