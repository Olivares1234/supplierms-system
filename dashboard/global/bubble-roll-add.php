<?php
    ...
    try{
        ...
        $stmt = $db->prepare("INSERT INTO tbl_supplier (sppr_raw_materials, sppr_company_name, sppr_address, sppr_product_lists, sppr_current_price, sppr_nationality, sppr_owner, sppr_contact_person, sppr_contact_num, sppr_fax_num, sppr_email, sppr_current_pay_terms, sppr_approved, sppr_remarks, sppr_status, sppr_raw_extension) 
        VALUES (:sppr_raw_materials, :sppr_company_name, :sppr_address, :sppr_product_lists, :sppr_current_price, :sppr_nationality, :sppr_owner, :sppr_contact_person, :sppr_contact_num, :sppr_fax_num, :sppr_email, :sppr_current_pay_terms, :sppr_approved, :sppr_remarks, :sppr_status, :sppr_raw_extension)");
