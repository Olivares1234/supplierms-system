...
<head>
	...
	<title>SUPPLIERMS- Minamoto Packaging Corporation</title>
				...
				<form action="config/login_config.php" method="POST" autocomplete="off">
					<div class="form-group form-floating-label">
						...
						<label for="username" class="placeholder">Username</label>
				         ...
				         <!-- <input id="role" name="role" type="text" class="form-control input-border-bottom"> -->
					<div class="form-group form-floating-label">
					...
					<div class="form-action mb-3">
						<input type="submit" class="btn btn-primary btn-rounded btn-login" name="btnsign" value="Sign In">
